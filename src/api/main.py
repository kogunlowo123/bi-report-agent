"""BI Report Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Business intelligence report generation agent that builds reports from natural language requests, creates visualizations, schedules automated delivery, and translates business questions into analytical queries.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
