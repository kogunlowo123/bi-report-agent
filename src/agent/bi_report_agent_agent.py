"""BI Report Agent - Main Agent Implementation."""
...
class BiReportAgentAgent:
    ...
    def __init__(self):
        ...
        self.visualization_creation_enabled = True
        self.automated_delivery_enabled = True
        self.query_translation_enabled = True
        self.template_management_enabled = True
        self._tool_dispatch = {
            "generate_report": self.tools.generate_report,
            "create_visualization": self.tools.create_visualization,
            "schedule_delivery": self.tools.schedule_delivery,
            "suggest_chart_type": self.tools.suggest_chart_type,
            "build_dashboard": self.tools.build_dashboard,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['report_generation', 'visualization_creation', 'automated_delivery', 'query_translation', 'template_management'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "suggest_chart_type": ['suggest', 'chart', 'type'],
